        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <?php if($categoryDetail != 0): ?>
                        <li class="active"><?php echo $categoryDetail["category_name"]; ?></li>
                    <?php endif; ?>
                </ol>
            </div>
        </div>
    ...
    <div class="collection-categories">
        ...
        <div class="collection-categories-content">
            <ul class="cc-list">
                <?php if($category != 0): foreach($category as $cat): ?>
                    <?php 
                    $subCat = $this->Mod_category->getSubCategory($cat['category_id']);
                    if( $subCat == 0): ?>
