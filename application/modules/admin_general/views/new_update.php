...
<div class="x_content">
    <form method="post" class="form-horizontal form-label-left" enctype = "multipart/form-data" novalidate> 
      <span class="section">Cập nhật option</span>
      <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Option name <span class="required">*</span>
        </label>
        <div class="col-md-9 col-sm-9 col-xs-12">
          <input id="name" class="form-control col-md-7 col-xs-12" name="option-name" placeholder="Option name" required="required" type="text" value="<?php echo $option['option_name']; ?>">
        </div>
      </div>
      <div class="item form-group">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <textarea id="option-value" name="option-value" required="required" class="form-control col-md-7 col-xs-12"><?php echo $option['option_value']; ?></textarea>
        </div>
      </div>
      <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="checkbox" name="autoload" value="1" class="js-switch" <?php if($option['option_autoload']==1){ echo 'checked';} ?> />  
        </div>
      </div>
